...
export default function TitleWithDoubleBorder({
  ...
  return (
    <div className="relative w-max">
      <div className="absolute top-0 left-0 w-28 h-0.5 bg-highlight rounded-md"></div>
      ...
      <div className="absolute bottom-0 right-0 w-28 h-0.5 bg-highlight rounded-md"></div>
