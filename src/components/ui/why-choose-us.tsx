    ...
    <Container effect="slide-left">
      <Glass className="flex gap-10 md:gap-2 px-10 py-10">
        ...
        <div className="w-full md:flex-1 flex flex-col gap-3 justify-center items-center">
          <ul className="flex gap-6 flex-wrap justify-center cursor-pointer mt-10">
            <li className="text-center flex gap-1 justify-center bg-highlight font-primary tracking-widest px-8 w-full md:w-[200px]  flex-col items-center text-white/90 py-6">
              <Icon icon={"iconamoon:profile-light"} className="text-4xl" />
              Professional consulting team
            </li>
            <li className="text-center flex gap-1 justify-center bg-background font-primary tracking-widest px-8 py-6 w-full md:w-[200px]  flex-col items-center text-white/90">
              <Icon icon={"hugeicons:absolute"} className="text-4xl" />
              Personalized solutions
            </li>
            <li className="text-center flex gap-1 justify-center bg-highlight  font-primary tracking-widest px-8 py-6 w-full md:w-[200px]  flex-col items-center text-white/90">
